...
export function WelcomePopup({ isAdmin, userId }: WelcomePopupProps) {
  ...
  >
    ...
    >
      {/* ВЕСЬ КОНТЕНТ МОДАЛКИ — flex, чтобы низ всегда был снизу */}
      <div className="flex flex-col max-h-[75vh]">
        ...
        {/* НИЗ — НЕ sticky, НЕ absolute, просто нормальный футер */}
        <div className="pt-2">
          <div className="flex justify-end">
            <Button onClick={handleClose} disabled={isAdmin && !accepted} size="lg">
              Начать работу 🚀
            </Button>
          </div>
        </div>
